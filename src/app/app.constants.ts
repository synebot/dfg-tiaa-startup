    ...
    },
    {
        ...
        fields: [
            ...
            },
            {
                ...
                toolTip: `Example:-> required:(this.formData[\'controlType\'] === \'select\' ||
                    this.formData[\'controlType\'] === \'multiselect\');disabled: this.formData[\'isActionConfig\'] === true`,
            },
        ],
    },
    {
        ...
        fields: [
            {
                ...
                toolTip: `Handle selected HTML event. Example:-> change:(this.formData[\'selectOption2\'] =
                    this.formData[\'selectOption1\'] === \'yes\' ? this.formData[\'selectOption1\'] : this.formData[\'selectOption2\']);`,
            },
            {
                disabled: false,
                required: false,
    ...
    },
    {
        ...
        fields: [
            ...
            },
            {
                ...
                showCondition: `[\'radio\', \'button\', \'hyperlink\', \'select\', \'select-text\', \'multiselect\',
                    \'hyperlink-lable\', \'objectTable\', \'dataTable\', \'customDataTable\'].indexOf(this.formData[\'controlType\']) === -1`,
            },
            {
                required: false,
        ...
        fields: [
            {
                ...
                showCondition: `this.formData[\'controlType\'] === \'select\' || this.formData[\'controlType\'] === \'multiselect\' ||
                    this.formData[\'controlType\'] === \'select-text\'`,
            },
            {
                disabled: false,
                required: false,
                ...
                showCondition: `!this.formData[\'isCustomListBinding\'] &&  this.formData[\'controlType\'] === \'select\' ||
                    this.formData[\'controlType\'] === \'multiselect\' || this.formData[\'controlType\'] === \'select-text\'`,
                dfgAttribute: `required:(this.formData[\'controlType\'] === \'select\' ||
                    this.formData[\'controlType\'] === \'multiselect\' || this.formData[\'controlType\'] === \'select-text\')`,
            },
        ],
    },
        ...
        fields: [
            {
                ...
                showCondition: `!this.formData[\'isCustomListBinding\'] && this.formData[\'listItemValueApi\'] != null &&
                    this.formData[\'listItemValueApi\'] != \'\' `,
    ...
    },
    {
        ...
        fields: [
            ...
            },
            {
                ...
                required: false,
                toolTip: 'Text Prefix',
                showCondition: `this.formData[\'controlType\'] === \'label\' || this.formData[\'controlType\'] === \'text\' ||
                    this.formData[\'controlType\'] === \'textarea\'`,
            },
            {
                controlType: 'text',
