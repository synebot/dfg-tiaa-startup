...
export class TabSectionComponent implements OnInit, OnDestroy, AppFormBase {
  public sectionName: string;

  public tabSection: Section;

  constructor(
    private route: ActivatedRoute, private router: Router, private appRuntimeInfoService: AppRuntimeInfoService,
